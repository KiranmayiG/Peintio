...
<div class="w3-top">
  <div class="w3-bar" id="myNavbar">
    ...
    <a class="dropdown-toggle w3-bar-item w3-button w3-hide-small" data-toggle="dropdown" href="#">GALLERY
        ...
        <ul id="abc" class="dropdown-menu w3-animate-zoom">
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium">
    ...
    <a href="logout.php" class="w3-bar-item w3-button">
            <i class="fa fa-sign-out"></i> Log Out</a>
    <a href="favourites.php" class="w3-bar-item w3-button">
             Favourites</a>
    <a href="#uploadimage" data-toggle="modal" data-target="#uploadimage" class="w3-bar-item w3-button w3-right w3-hide-small">
             Upload</a>
    <?php } else { ?>
      <a href="#usersignup" class="w3-bar-item w3-button"  data-link-alt="Sign Up" data-toggle="modal" data-target="#usersignup" onclick="toggleFunction()">SIGN UP</a>
      <a href="#usersignin" class="w3-bar-item w3-button"  data-link-alt="Sign in" data-toggle="modal" data-target="#usersignin" onclick="toggleFunction()">SIGN IN</a>
